...
const FUEL_TYPES = [
  ...
  {
    id: "lpg", label: "LPG", shortLabel: "LPG",
    icon: "🔥", emoji: "⛽",
    pricePerL: 860.00, unit: "Cylinder", unitLabel: "per cylinder",
    minQty: 1, maxQty: 500, step: 1,
    tag: "Coming Soon", tagColor: "bg-gray-100 text-gray-500",
    gradient: "from-red-300 to-rose-400",
    cardBg: "bg-red-50 border-red-200",
    activeBg: "border-[#155c32] bg-[#155c32]/5",
    desc: "Liquefied Petroleum Gas for industrial heating systems",
    available: false,
  },
  {
    id: "def", label: "DEF (AdBlue)", shortLabel: "AdBlue",
    icon: "💎", emoji: "💧",
    pricePerL: 45.00, unit: "L", unitLabel: "per litre",
    minQty: 20, maxQty: 5000, step: 10,
    tag: "Coming Soon", tagColor: "bg-gray-100 text-gray-500",
    gradient: "from-cyan-300 to-sky-400",
    cardBg: "bg-cyan-50 border-cyan-200",
    activeBg: "border-[#155c32] bg-[#155c32]/5",
    desc: "Premium Diesel Exhaust Fluid for SCR engines",
    available: false,
  },
  {
