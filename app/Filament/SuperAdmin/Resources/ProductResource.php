            ...
            Forms\Components\Grid::make(3)->schema([
                Forms\Components\Group::make()->schema([
                    Forms\Components\Section::make('Product Details')->schema([
                        ...
                        Forms\Components\Textarea::make('description')->label('Legacy Description')->rows(2)->nullable()->columnSpanFull(),
                    ])->columns(2),
                ])->columnSpan(2),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('vendor.brand_name')->label('Vendor')->sortable(),
