    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'product_image' => $this->product_image
                ? (filter_var($this->product_image, FILTER_VALIDATE_URL) ? $this->product_image : Storage::disk('public')->url($this->product_image))
                : null,
            ...
            'approval_status_label' => $this->approval_status instanceof ListingStatus
